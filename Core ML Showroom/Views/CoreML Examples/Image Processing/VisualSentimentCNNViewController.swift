//
//  VisualSentimentCNNViewController.swift
//  Core ML Showroom
//
...
class VisualSentimentCNNViewController: ModelViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
