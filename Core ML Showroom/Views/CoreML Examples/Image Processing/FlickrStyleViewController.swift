//
//  FlickrStyleViewController.swift
//  Core ML Showroom
//
...
class FlickrStyleViewController: ModelViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        guard let model = try? VNCoreMLModel(for: FlickrStyle().model) else {return}
